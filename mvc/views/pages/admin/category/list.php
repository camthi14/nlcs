<div class="container">
    <div class="flex gap-3 mb-3 justify-between">
        <a href="<?php echo _WEB_ROOT . '/category/cateAdd' ?>" class="btn bg-[#252c30] hover:bg-slate-700 text-white ">Add Category</a>
    ...
    <table class="table table-bordered border-primary table_s">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<?php echo _WEB_ROOT . '/category/handleUpdateCate/' . $cate['id'] ?>" style="font-size: 24px;" class="text-pink-900 d-block text-center hover:text-pink-900"><i class="transition-all duration-300 hover:scale-110 hover:cursor-pointer far fa-edit"></i></a></td>
                <td><a href="<?php echo _WEB_ROOT . '/category/handleDeleteCate/' . $cate['id'] ?>" style="font-size: 24px; " class="delete_handle text-danger d-block text-center"><i class="transition-all duration-300 hover:scale-110 hover:cursor-pointer fas fa-trash-alt"></i></a></td>
            </tr>
